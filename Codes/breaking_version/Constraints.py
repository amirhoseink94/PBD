    ...
    for i in range(len(particles)):
        for j in range(len(particles)):
            if M[i, j] != 0:
                ...
                # checking if the object going to break or not
                if norm2(dp_1) > particles[i].breaking_point or norm2(dp_2) > particles[j].breaking_point:
                    M[i, j] = 0
                    print("WOW! a big break!")
                    # xx = input("Thor helps us!")
                    return
                ### ---end if---
                k_1 = 1
                k_2 = 1
